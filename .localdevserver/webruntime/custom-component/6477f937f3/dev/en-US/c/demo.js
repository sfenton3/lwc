Webruntime.define('lwc/demo', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    tmpl$4.stylesheetTokens = {
      hostAttribute: "lwc-demo_demo-host",
      shadowAttribute: "lwc-demo_demo"
    };

    class Demo extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.text = 'This text came from a JS prop';
      }

    }

    lwc.registerDecorators(Demo, {
      fields: ["text"]
    });

    var demo = lwc.registerComponent(Demo, {
      tmpl: _tmpl$5
    });
