Webruntime.define('lwc/test', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-input", _lightningInput, {
        ...
        key: 1,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.updateText))
        }
      }, []), api_element("hr", {
        key: 2
      }, []), api_dynamic($cmp.outputText)];
    }
    ...
    var test = lwc.registerComponent(App, {
      tmpl: _tmpl$l
    });
