Webruntime.define('lwc/stopwatch', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 0
      }, [api_dynamic($cmp.timeVal)]), $cmp.showStartBtn ? api_custom_element("lightning-button", _lightningButton, {
        styleMap: {
          "marginLeft": "145px"
        },
        props: {
      ...
      }, []) : null, !$cmp.showStartBtn ? api_custom_element("lightning-button", _lightningButton, {
        styleMap: {
          "marginLeft": "145px"
        },
        props: {
        ...
        key: 2,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.stop))
        }
      }, []) : null, api_custom_element("lightning-button", _lightningButton, {
        styleMap: {
          "marginLeft": "10px"
        },
        props: {
        ...
        key: 3,
        on: {
          "click": _m2 || ($ctx._m2 = api_bind($cmp.reset))
        }
      }, [])])];
    }
    ...
    class Stopwatch extends lwc.LightningElement {
      constructor(...args) {
        ...
        this.timeIntervalInstance = void 0;
        this.totalMilliseconds = 0;
      }

      start(event) {
        this.showStartBtn = false;
        var parentThis = this; // Run timer code in every 100 milliseconds
        ...
        this.timeIntervalInstance = setInterval(function () {
          ...
          var milliseconds = Math.floor(parentThis.totalMilliseconds % 1000); // Output the result in the timeVal variable
    ...
    lwc.registerDecorators(Stopwatch, {
      ...
      fields: ["timeIntervalInstance", "totalMilliseconds"]
    });
